...
1. ([Free, Basic, and Professional teams only](https://www.postman.com/pricing/)) If you're sharing a collection, folder, or request, you can optionally select an environment to be the active environment. This will be the active environment for the team members and groups you want to share with. Select the **Select an Environment** dropdown list and choose the environment.
