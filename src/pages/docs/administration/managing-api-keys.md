...
When you enable this setting and if there are any exposed API keys, a confirmation window will appear. You can choose to revoke the exposed keys when you enable this setting or ignore them and enable the setting. Any publicly exposed keys detected by the Secret Scanner after you enable this setting will be automatically revoked.
