...
You can choose to automatically revoke exposed Postman API keys found in publicly accessible Postman resources, [GitHub repositories](/docs/administration/secret-scanner/#protecting-postman-api-keys-in-github), and [Gitlab repositories](/docs/administration/token-scanner/#protecting-postman-api-keys-in-gitlab). To do this, select the toggle next to **Auto revoke exposed Postman API keys**. If you need to revoke all of the Postman API keys generated by your team, select **Revoke All**. Postman notifies users by email when their API keys are revoked.
