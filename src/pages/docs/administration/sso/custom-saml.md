...
To configure SSO with custom SAML, create a custom SAML application in your identity provider (IdP). You must be an administrator in both the IdP and Postman to configure SSO for your team.
