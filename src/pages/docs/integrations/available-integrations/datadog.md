...
Setting up a Datadog integration requires you to get an API key from Datadog and configure your monitors. After you set up the integration, you can view real-time alerts based on the results of your monitors.
