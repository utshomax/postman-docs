...
Postman often checks your collection for changes. If Postman identifies changes to your collection, the changes are automatically sent to Microsoft Power Automate.
