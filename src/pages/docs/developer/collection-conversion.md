...
After learning the fundamentals of using converters to automate Postman Collection runs with your development, testing, or deployment pipeline, you could learn about using the Postman API in your CI/CD workflow:
