...
If you're working with the Collection SDK to automate part of your collection run workflow, you could integrate your Collection SDK development with Newman, Postman's command-line collection runner:
