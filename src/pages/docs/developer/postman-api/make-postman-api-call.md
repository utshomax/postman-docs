...
After you create your API key, store it as a [Postman environment variable](/docs/sending-requests/managing-environments/#adding-environment-variables). You can use environments to store values that you can later use to make your requests.
