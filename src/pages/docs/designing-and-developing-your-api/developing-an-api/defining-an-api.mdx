...
1. Select a reason that you want to hide it, then select **Hide** again.
    ...
    <img alt="Choose reason for hide rule in your API definition" src="https://assets.postman.com/postman-docs/v10/api-definition-hide-rule-violation-choose-reason-v10.jpg" width="300px"/>
