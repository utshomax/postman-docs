...
> **The maximum number of APIs you can create is determined by your Postman plan. Learn more about what's included with each plan. [Learn more about what's included with each plan](https://www.postman.com/pricing/).**