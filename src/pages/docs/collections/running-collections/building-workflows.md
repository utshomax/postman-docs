...
<img alt="Setting the next request" src="https://assets.postman.com/postman-docs/v10/set-next-request-v10.jpg" width="841px">
...
<img alt="Looping over a request" src="https://assets.postman.com/postman-docs/v10/set-next-request-loop-v10.jpg" width="841px">
