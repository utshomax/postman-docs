...
Sign in to Postman in your browser by entering your account credentials or signing in with Google. If you're signing in to a Postman Professional or Enterprise team with SSO enabled, opt to **Sign in with SSO**. To learn more, see [Logging in to an SSO team](/docs/administration/sso/user-sso/).
