...
* **Offline Postman API Client** - You can use the [offline API Client](/docs/getting-started/using-offline-api-client/) to send requests from the Postman desktop app when you aren't signed in to Postman.
