...
* **Offline API Client** - You can use the [API Client](/docs/getting-started/using-api-client/) to send requests from the Postman desktop app when you aren't signed in to Postman.
