...
> Postman Flows is free to use for up to three users in the Free plan. Postman Flows is available as an add-on in the [Professional plan](https://www.postman.com/pricing/). Postman Flows is not available in the Basic and Enterprise plans.
