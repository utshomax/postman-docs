...
* **Authorization** - Enter authorization credentials here. You can choose from a list of auth types including API Key, Basic auth, and Bearer token. Learn more about authorizing requests [here](https://learning.postman.com/docs/sending-requests/authorization/).
