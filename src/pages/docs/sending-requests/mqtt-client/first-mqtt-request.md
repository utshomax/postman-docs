...
While being connected to the broker, go to the **Topics** tab. This interface enables you to list down and document multiple topics and subscribe to them.
...
1. Switch to the **Visualization** tab in the response area. You will see the messages for `age` field visualized as a line chart.
2. Select the field name dropdown to select the field you want to visualize.
3. Select the ----{Image: + icon}---- icon to add more fields to the chart and view the changes in their values together.
4. Select the ----{Image: chart icon}---- next to any of the field names to change the chart type.
