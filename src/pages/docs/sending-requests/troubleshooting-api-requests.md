...
**CORS** |If Postman fails to send your request, you may be experiencing a Cross Object Resource Sharing (CORS) error. Make sure you're using the best [Postman Agent](/docs/getting-started/about-postman-agent/) for your request.
