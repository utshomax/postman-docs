...
> <img alt="Collections icon" src="https://assets.postman.com/postman-docs/Collections.png#icon" width="24px"> Try out examples of different types of authorization in a collection template that are ready to be modified to fit your use case. To try out this template, select [Authorization methods](https://www.postman.com/templates/31a9a6ed-4cdf-4ced-984c-d12c9aec1c27/Authorization-methods).
