...
<img alt="Settings icon" src="https://assets.postman.com/postman-docs/icon-settings-v9.jpg#icon" width="16px">, then select **Settings > General** and turn off **Security Warnings count**. While the number of warnings will no longer display next to the **Security** tab, you can still select this tab to inspect any warnings.
