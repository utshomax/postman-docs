...
> [Saved examples](/docs/sending-requests/using-grpc-examples/) are also useful for developing endpoint-dependent features before the API is complete and accessible.
