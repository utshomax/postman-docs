...
Postman automatically creates documentation for your collections and APIs. To give your consumers more help and context, use Postman's built-in editing tools to add descriptions to your documentation. You can use the Postman editor to view how your content will look as you write it. Or use standard Markdown syntax to write content and leave the formatting to Postman.
